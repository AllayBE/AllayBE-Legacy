...
{
	uint8_t *packetBuffer = (uint8_t *)rakMalloc_Ex(sizeof(packet), _FILE_AND_LINE_);
	...
	BitStream *gamePacketStream = new BitStream(gamePacketBuffer, packetStream->GetNumberOfBytesUsed(), true);
